...
## Bugs &nbsp; [![NPM version](https://badge.fury.io/js/@faou/sails-generate-migration.svg)](http://npmjs.com/package/@faou/sails-generate-migration)
...
[![NPM](https://nodei.co/npm/@faou/sails-generate-migration.png?downloads=true)](http://npmjs.com/package/@faou/sails-generate-migration)



## License

This migration generator is available under the **MIT license**.
